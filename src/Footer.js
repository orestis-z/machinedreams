        ...
        >
            ...
            >
                <div style={{marginBottom: 40}}>
                    ...
                    <FontAwesomeIcon icon={faTwitter} size="lg" />
                    <Hover>
                        <a href="https://instagram.com/machinedreamsart" target="_blank"><FontAwesomeIcon icon={faInstagram} color="white" size="2xl"/></a>
                    </Hover>
                </div>
                ...
                <Hover>
                    <HashLink
                     onClick={() => window.location.pathname.startsWith("/terms") || ReactGA.send({hitType: "pageview", page: "/terms"})}
                    to="/terms/#"
                    className="link"
